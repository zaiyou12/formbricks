...
export const templates: TTemplate[] = [
  {
    name: "메일링리스트",
    category: "Custom",
    description: "캠페인 메일링리스트, 보유 주식수 질문",
    preset: {
      name: "캠페인 메일링리스트",
      ...
      questions: [
        {
          ...
          inputSets: [
            ...
            },
            {
              ...
              inputType: "phone",
              longAnswer: false,
              placeholder: "010 0000 0000 (전화번호를 입력해주세요)",
            },
          ],
          buttonLabel: "다음",
          backButtonLabel: "이전",
          ...
          inputSets: [
            {
              ...
              subheader: "",
              longAnswer: false,
              placeholder: "example@email.com (이메일을 입력해주세요)",
            },
            {
              id: createId(),
              ...
              inputType: "text",
              longAnswer: false,
              placeholder: "소속/기관 (소속 정보를 입력해주세요)",
            },
          ],
          subheader: "기재해주신 정보로 캠페인 관련 안내를 드릴 예정입니다.",
          buttonLabel: "다음",
          backButtonLabel: "이전",
        },
        {
          id: createId(),
          type: TSurveyQuestionType.MultipleChoiceMultiAnswer,
          logic: [],
          choices: [
            { id: createId(), label: "KB금융지주" },
            { id: createId(), label: "신한지주" },
            { id: createId(), label: "하나금융지주" },
            { id: createId(), label: "우리금융지주" },
            { id: createId(), label: "JB금융지주" },
            { id: createId(), label: "BNK금융지주" },
            { id: createId(), label: "DGB금융지주" },
          ],
          headline: "종목과 주식수를 입력해주세요 (선택)",
          required: true,
          subheader: "아래 기입 이외, 비사이드 앱 주주인증을 진행해주셔도 됩니다.",
          buttonLabel: "다음",
          shuffleOption: "none",
          backButtonLabel: "이전",
        },
        {
          id: "advqd84c2nhdrj06jt6rb2h2",
          type: TSurveyQuestionType.MultipleChoiceMulti,
          logic: [],
          choices: [
            { id: createId(), label: "(필수)개인정보 수집 동의" },
            { id: createId(), label: "(선택)캠페인 정보 관련 안내" },
          ],
          headline: "개인정보 수집동의",
          required: true,
          subheader: "",
